...
================================
VERSION: 1.8.0 (Fast-Mode Intercept)
"""
import pandas as pd
...
def compare_timeseries(ds_p, ds_g, tmp_dir, pair_info, instr, prod_name, log, m_flag, fast_mode=False):
    ...
    for var in variables:
        ...
        # Only export the single dashboard compilation plot in Fast Mode
